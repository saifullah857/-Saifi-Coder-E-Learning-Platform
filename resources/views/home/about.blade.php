        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4" style="color: #fb873f;">Welcome to Saifi-Coder</h1>
                    <p class="mb-4">
                        At Saifi-Coder, we believe in accessible, innovative learning experiences that adapt to your
                    ...
                    <p class="mb-4">Welcome to Saifi-Coder, where learning knows no boundaries. Our mission
                        is to empower individuals worldwide through accessible and innovative education. Here's what
                        sets us apart:</p>

                    <h3 class="mb-4">Our Vision</h3>
                    <p class="mb-4">At Saifi-Coder, we envision a world where learning is accessible to everyone,
                    ...
                    <p class="mb-4">We believe in the transformative power of education. Saifi-Coder is
                    ...
                    <p class="mb-4"> Saifi-Coder is more than just courses; it's a vibrant community. We
                    ...
                    <p class=" mt-5 mb-4">Thank you! for being a part of Saifi-Coder. Together, let's embark on a
