            ...
            <div class="row g-4">
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">I'm happy to help! If you're looking for contact information or details about
                        Saifi-Coder's online free courses website for e-learning, I don't have real-time browsing
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            <h5>Office</h5>
                            <p class="mb-0">Aspir College Phool Nagar</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0"
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h5>Email</h5>
                            <p class="mb-0">Saifi-coder@gmail.com</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="name" required placeholder="Your Name" name="name" @if (Auth::id())
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-floating">
                                    <input type="email" class="form-control" id="email" required
                                        placeholder="Your Email" name="email" @if (Auth::id())
