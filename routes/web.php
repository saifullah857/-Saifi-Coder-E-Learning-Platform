...
/*
|--------------------------------------------------------------------------
| AUTH USER ROUTES (Login Required)
|--------------------------------------------------------------------------
*/

// Course enrollment (must login)
...
// Instructor page (must login)
Route::get('/instructer', [HomeController::class, 'instructer'])
    ->name('instructer')
    ->middleware('auth');
...
/*
|--------------------------------------------------------------------------
| ADMIN ROUTES (Login Required - Admin Panel)
|--------------------------------------------------------------------------
*/
...
Route::middleware(['auth','admin'])->group(function () {
    ...
    */
    ...
    |-----------------------
    */
    Route::post('/instructordata', [AdminController::class, 'instructerdata'])
        ->name('instructordata');

    Route::get('/instructer_appointment', [AdminController::class, 'instructer_appointment']);

    Route::get('/send_emailtoinstructer/{id}', [AdminController::class, 'send_emailtoinstructer'])
        ->name('send_emailtoinstructer');
...
/*
|--------------------------------------------------------------------------
| AUTH ROUTES (Laravel Breeze / Auth system)
|--------------------------------------------------------------------------
*/
